...
{
    public delegate void SubjectSearchListLinkCreateClick();

    partial class SubjectSearchList
    {
        #region Class Event Declarations
        public event SearchListDataGridDoubleClickEnter OnDoubleClickEnter;
        public event SubjectSearchListLinkCreateClick OnCreate;
        #endregion
        ...
        {
            SubjectSearchListLinkCreateClick ev = OnCreate;
