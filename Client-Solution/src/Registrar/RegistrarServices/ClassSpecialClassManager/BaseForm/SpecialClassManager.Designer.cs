namespace RegistrarServices
{
    partial class SpecialClassManager
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SpecialClassManager));
            this.lblRecordDate = new System.Windows.Forms.Label();
            this.ctlManager = new RemoteClient.ControlSpecialClassManager();
            this.SuspendLayout();
            // 
            // lblRecordDate
            // 
        ...
        private RemoteClient.ControlSpecialClassManager ctlManager;
