...
{
    partial class EmployeeSearchOnTextboxList
    {
        ...
        protected override void ClassLoad(object sender, EventArgs e)
        {
            ...
            this.SetDataGridViewSource(_specialManager.EmployeeTableFormat);
        ...
        protected override void txtSearchKeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                try
                {
                    ...
                    this.SetDataGridViewSource(_specialManager.GetSearchedEmployeeInformation(((TextBox)sender).Text));
                }
                catch (Exception ex)
                {
