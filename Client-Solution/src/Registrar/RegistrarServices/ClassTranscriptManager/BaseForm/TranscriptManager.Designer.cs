namespace RegistrarServices
{
    partial class TranscriptManager
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TranscriptManager));
            this.lblRecordDate = new System.Windows.Forms.Label();
            this.ctlManager = new RemoteClient.ControlTranscriptManager();
            this.SuspendLayout();
            // 
            // lblRecordDate
            // 
        ...
        private RemoteClient.ControlTranscriptManager ctlManager;
    }
}