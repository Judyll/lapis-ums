...
{
    public delegate void SearchListLoanDataGridDoubleClickEnter(String id);
    public delegate void LoanTypeSearchListLinkCreateClick();

    partial class LoanTypeSearchList
    {
        #region Class Event Declarations
        public event SearchListLoanDataGridDoubleClickEnter OnDoubleClickEnter;
        public event LoanTypeSearchListLinkCreateClick OnCreate;
        #endregion
        ...
        protected Int32 _primaryIndex = 0;
        ...
        private void dgvListDoubleClick(object sender, EventArgs e)
        {
            ...
            {
                SearchListLoanDataGridDoubleClickEnter ev = OnDoubleClickEnter;
        ...
        {
            LoanTypeSearchListLinkCreateClick ev = OnCreate;
