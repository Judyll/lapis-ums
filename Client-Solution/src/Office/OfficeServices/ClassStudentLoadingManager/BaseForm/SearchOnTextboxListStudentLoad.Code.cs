...
namespace OfficeServices
{
    partial class SearchOnTextboxListStudentLoad
    {
        ...
        private Int32 _enterRowIndex = 0;
        #endregion
        ...
        protected Boolean _hasSelected;
        ...
        public SearchOnTextboxListStudentLoad()
        {
        ...
        protected virtual void  ClassLoad(object sender, EventArgs e)
        {
            ...
            _ttpTool.SetToolTip(pbxDone, "Close");
            _ttpTool.SetToolTip(pbxRefresh, "Refresh");            
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                switch (hitTest.Type)
                {
                    case DataGridViewHitTestType.Cell:
                        _rowIndex = _enterRowIndex = hitTest.RowIndex;
                        break;
        ...
        private void dgvListKeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                if (_enterRowIndex != this.dgvList.Rows.Count - 1)
                {
                    _enterRowIndex++;

                    this.dgvList.Rows[_enterRowIndex].Selected = true;                    
                }
            }
            else
            {
        ...
        protected virtual void pbxDoneClick(object sender, EventArgs e)
        {
            this.Close();
        } //--------------------------
