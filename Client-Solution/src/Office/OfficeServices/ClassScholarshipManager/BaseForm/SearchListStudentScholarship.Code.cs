...
{
    public delegate void SearchListDataGridDoubleClickEnterStudentScholarship(String id);
    public delegate void StudentSearchButtonCreateSchoolshipClick();

    partial class SearchListStudentScholarship
    {
        ...
        public event SearchListDataGridDoubleClickEnterStudentScholarship OnDoubleClickEnter;
        public event StudentSearchButtonCreateSchoolshipClick OnCreate;
        #endregion
        ...
        private void dgvListDoubleClick(object sender, EventArgs e)
        {
            ...
            {
                SearchListDataGridDoubleClickEnterStudentScholarship ev = OnDoubleClickEnter;
        ...
        private void dgvListDataSourceChanged(object sender, EventArgs e)
        {
            ...
            if (result == 1)
            {
                _primaryId = dgvList[_primaryIndex, 0].Value.ToString();
            }
            else
            {
                _primaryId = "";
        ...
        {
            StudentSearchButtonCreateSchoolshipClick ev = OnCreate;
        ...
        //this procedure will set create button visible
        public void IsVisibleButtonCreate(Boolean value)
        {
