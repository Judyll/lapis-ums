...
namespace BaseServices
{
    ...
    public delegate void SearchListDataGridContextMenuClick(String id);
    ...
    partial class SearchList
    {
        ...
        public event SearchListDataGridContextMenuClick OnCashierUpdateClick;
        public event SearchListDataGridContextMenuClick OnDataControllerUpdateClick;
        public event SearchListDataGridContextMenuClick OnViewEnrolmentHistoryClick;
        #endregion
        ...
        public SearchList()
        {
            ...
            this.mnuItemUpdateBasic.Click += new EventHandler(mnuItemUpdateBasicClick);
            this.mnuItemUpdateAdvance.Click += new EventHandler(mnuItemUpdateAdvanceClick);
            this.mnuItemViewStudentEnrolmentHistory.Click += new EventHandler(mnuItemViewStudentEnrolmentHistoryClick);
        }

        void mnuItemViewStudentEnrolmentHistoryClick(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(_primaryId))
            {
                SearchListDataGridContextMenuClick ev = OnViewEnrolmentHistoryClick;

                if (ev != null)
                {
                    OnViewEnrolmentHistoryClick(_primaryId);
                }
            }
        }

        void mnuItemUpdateAdvanceClick(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(_primaryId))
            {
                SearchListDataGridContextMenuClick ev = OnDataControllerUpdateClick;

                if (ev != null)
                {
                    OnDataControllerUpdateClick(_primaryId);
                }
            }
        }

        void mnuItemUpdateBasicClick(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(_primaryId))
            {
                SearchListDataGridContextMenuClick ev = OnCashierUpdateClick;

                if (ev != null)
                {
                    OnCashierUpdateClick(_primaryId);
                }
            }
        }
        #endregion
        ...
        private void ClassLoad(object sender, EventArgs e)
        {
            ...
            ProcStatic.SetDataGridViewColumns(dgvList, _adoptGridSize);
            ...
            //{
                ...
                switch (hitTest.Type)
                {
                    case DataGridViewHitTestType.Cell:
                        ...
                        this.dgvList.ContextMenuStrip = this.mnuUpdate;
                        break;
                ...
                if (rowIndex != -1)
                {
                    ...
                    this.dgvList.Rows[rowIndex].Selected = true;
                }               
            //}
        } //-----------------------------
        ...
        //this procedure disables the context menu
        public void DisableContextMenu(Boolean isDisabled, Boolean forDataController, Boolean forCashierRegistrar, Boolean forRegistrar)
        {
            this.mnuItemUpdateBasic.Visible = forCashierRegistrar;
            this.mnuItemUpdateAdvance.Visible = forDataController;
            this.mnuItemViewStudentEnrolmentHistory.Visible = forRegistrar;
            ...
            {
                this.dgvList.ContextMenuStrip = mnuUpdate;
            }
        } //----------------------------------
