...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" href="StyleSheetMain.css" type="text/css" />
</head>
<body>
         ...
         <div id="searchwrapper"> 
            <div id="searchbox">
                <asp:TextBox ID="txtSearch" runat="server" AutoPostBack="true" Width="520" BackColor="transparent"  
                    BorderColor="transparent" Font-Size="16" ForeColor="#ced1d1" CssClass="searchbox"></asp:TextBox>
                
                <asp:HyperLink ID="lnkGo" runat="server" Text="" ImageUrl="images/search_blank_bg.gif" 
                    NavigateUrl="~/default.aspx?panelView=search&queryString=Go" CssClass="searchbox_submit" ToolTip="Search"> </asp:HyperLink>
               
                <asp:HyperLink ID="lnkAll" runat="server" Text="Search All" ImageUrl="images/searchall_blank_bg.gif"
                    NavigateUrl="~/default.aspx?panelView=search&queryString=%%" CssClass="searchbox_all" ToolTip="Search All"> </asp:HyperLink>
            </div>
